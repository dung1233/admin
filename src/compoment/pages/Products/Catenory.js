                                                                ...
                                                                <div className="d-flex align-items-center">
                                                                    <div className="avatar-wrapper me-3 rounded-2 bg-label-secondary">
                                                                        <div className="avatar">
                                                                            <img
                                                                                src={category.image || 'default-image.jpg'} // Nếu không có ảnh, đặt ảnh mặc định
                                                                                alt=""
                                                                    ...
                                                                    <div className="d-flex flex-column justify-content-center">
                                                                        <span className="text-heading text-wrap fw-medium">{category.categoryName}</span>
